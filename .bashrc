...
alias gitadd="find /home/vagar -maxdepth 1 -name '.bash*' -or -name '.Rprofile' -or -name '.inputrc' | xargs git add; find /home/vagar/predict_expression -name '*.py' -or -name '*.ipynb' -or -name '*.sb' -or -name '*.gin' -or -name '*.joblib' -or -name '*.sh' -or -name '*.json' -or -name '*.yaml' -or -name 'BUILD' -or -name '*.gin'| xargs git add; git commit -m 'commit'; git push origin master"
